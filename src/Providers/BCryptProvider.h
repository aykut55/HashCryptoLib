#ifndef CRYPTOAPI_PROVIDERS_BCRYPT_PROVIDER_H
#define CRYPTOAPI_PROVIDERS_BCRYPT_PROVIDER_H
...
class CBCryptProvider : public IAeadCipher, public IKeyDerivation, public IRandomSource
{
public:
    virtual ~CBCryptProvider();
             CBCryptProvider();
