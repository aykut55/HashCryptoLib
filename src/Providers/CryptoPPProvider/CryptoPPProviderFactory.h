#ifndef CRYPTOAPI_PROVIDERS_CRYPTOPP_PROVIDER_FACTORY_H
#define CRYPTOAPI_PROVIDERS_CRYPTOPP_PROVIDER_FACTORY_H
...
class CCryptoPPProviderFactory : public ICryptoProviderFactory
{
public:
    virtual ~CCryptoPPProviderFactory();
             CCryptoPPProviderFactory();
