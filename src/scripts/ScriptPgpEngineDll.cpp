...
std::vector<unsigned char> CScriptPgpEngineDll::callBinaryOutput(const char* methodName, const std::function<int(int, unsigned char*, int*)>& fn) const
{
    try
    {
        int requiredSize = 0;
...
std::string CScriptPgpEngineDll::callTextOutput(const char* methodName, const std::function<int(int, char*, int*)>& fn) const
{
    try
    {
        int requiredSize = 0;
...
void CScriptPgpEngineDll::callVoid(const char* methodName, const std::function<int(void)>& fn) const
{
    try
    {
        int rc = fn();
...
CScriptPgpEngineDll::~CScriptPgpEngineDll()
{
}
// -----------------------------------------------------------------------------

CScriptPgpEngineDll::CScriptPgpEngineDll(IPgpEngine* engine) : engine_(engine)
{
}
// -----------------------------------------------------------------------------

void CScriptPgpEngineDll::GenerateKeyPair(const std::string& userId, const std::string& password)
{
...
std::string CScriptPgpEngineDll::ExportPublicKeyArmored(void)
{
...
void CScriptPgpEngineDll::ImportPeerPublicKey(const std::string& keyBlockArmored)
{
...
std::string CScriptPgpEngineDll::EncryptStringArmored(const std::string& input)
{
...
std::vector<unsigned char> CScriptPgpEngineDll::DecryptStringArmored(const std::string& password, const std::string& input)
{
